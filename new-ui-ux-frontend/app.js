  ...
  if (postsList.length > 1) {
    ...
    if (dates.length > 1) {
      ...
      if (daysSpan >= 1) {
        ...
        velocityVal = recentDates.length / 1; 
      }
      
      // Sanity cap: No normal creator averages 9 posts a day over 15 posts. 
      // If it evaluates this high, it's a timestamp data error. Cap it realistically.
      if (velocityVal > 2.0) {
        velocityVal = 0.4; // Realistic fallback default
      }
    }
