...
async function fetchDynamicThumbnail(post, imgElement) {
  ...
  if (url && url !== '#') {
    try {
      const apiUrl = (typeof BACKEND_URL !== 'undefined' ? BACKEND_URL : 'http://localhost:8000') + `/api/proxy-image?url=${encodeURIComponent(url)}`;
      ...
      list.forEach(item => {
        ...
        div.innerHTML = `
          ...
          <div class="acct-meta">
            ...
            <div class="s">${followersFormatted} followers</div>
          </div>
        ...
        <div class="competitor-card-body">
          ...
          <div class="comp-stats-grid">
            ...
            <div class="comp-stat-box">
              ...
              <span class="comp-stat-box-val">${(velocity * 7).toFixed(1)} <span style="font-size:8px; font-weight:500;">/wk</span></span>
            </div>
          </div>
